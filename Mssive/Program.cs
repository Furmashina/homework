                ...
                switch (input)
                {
                    case 1:
                        ...
                        if (approve)
                        {
                            ser[index_ser] = seria;
                            index_ser++;
                            Console.WriteLine("Серия добавлена");
                        }
                        ...
                        if (approve)
                        {
                            name[index_name] = imya;
                            index_name++;
                            Console.WriteLine("Имя добавлено");
                        }
                        break;
                    case 2:
                        for (int i = 0; i < ser.Length; i++)
                        ...
                        break;
                    case 3:
                        Console.WriteLine("напишите индекс серии");
                        int idx_ser = int.Parse(Console.ReadLine());
                        ser[idx_ser] = ser[index_ser - 1];
                        ser[index_ser - 1] = null; //для интовых чисел не работает null? 
                        index_ser--;
                        Console.WriteLine("напишите индекс номера");
                        int idx_numb = int.Parse(Console.ReadLine());
                        numb[idx_numb] = numb[index_numb - 1];
                        numb[index_numb - 1] = null;
                        index_numb--;
                        Console.WriteLine("Напишите индекс имени");
                        string idx_name = Console.ReadLine();
                        name[idx_name] = name[index_name - 1];//я же сюда вписал стринг переменную...
                        name[index_name - 1] = null;
                        index_name--;
                        break;
                    case 4:
                        ...
                        {
                            Console.WriteLine("Паспорта нет");
                        }
                        break;
                    case 5:
